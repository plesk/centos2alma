...
def main():
    ...
    opts.add_option("--test-finish", action="store_const", dest="stage", const=Stages.test | Stages.finish, help=SUPPRESS_HELP)
    opts.add_option("--test-revert", action="store_const", dest="stage", const=Stages.test | Stages.revert, help=SUPPRESS_HELP)
